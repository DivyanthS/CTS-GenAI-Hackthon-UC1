...
export function InvestigationQueue() {
  ...
  const columns: Column<Investigation>[] = [
    ...
    { key: "claim_id", header: "Claim", sortValue: (r) => r.claim_id, render: (r) => <span className="font-mono text-xs">{r.claim_id}</span> },
    ...
    { key: "assigned_to", header: "Assigned To", sortValue: (r) => r.assigned_to, render: (r) => r.assigned_to },
